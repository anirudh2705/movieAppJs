...
const URL = "https://replit.com/AnirudhPatnaik1/movie-api";
...
const createMoviecard = (movies) => {
  for (let movie of movies) {
    ...
    //star icon
    const icon = ratings.appendChild(createElement("span"));
    icon.classList.add("material-symbols-outlined");
    icon.innerHTML = "star";

    //ratings
    const ratingVal = ratings.appendChild(createElement("span"));
    ratingVal.innerHTML = movie.imdb_rating;

    // movie duration
    const duration = ratingContainer.appendChild(createElement("p"));
